<template>
    <div>
        <div class="card">
            ...
            <div class="table-responsive" v-if="!loading && subscribers.length">
            ...
            <div class="card bg-white py-5 text-center" v-if="!loading && !subscribers.length">
                <h5>There are no subsribers for this project yet. Please add one first!</h5>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="text-center">
                            <a href="https://telegram.me/TeleNotyBot" class="btn btn-primary" target="_blank">Open Telegram</a>
                        </div>
                    </div>
